...
namespace DTcms.Web.admin.article
{
    public partial class list : PageBase
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            switch (this.prolistview)
            {
                ...
                default:
                    ...
                    this.rptList2.DataSource = bll.GetNewsList(this.pageSize, this.page, _strWhere, _orderby, out this.totalCount);
        ...
        {
            Utils.WriteCookie("article_list_view", "Txt", 43200);
            Response.Redirect(Utils.CombUrlTxt("list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
        ...
        {
            Utils.WriteCookie("article_list_view", "Img", 43200);
            Response.Redirect(Utils.CombUrlTxt("list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property, this.page.ToString()));
        }
